function showHome() {
    let html = `<nav class="navbar navbar-expand-md navbar-dark mb-4" style="background-color:#3097D1">
                ...
                <div class="left-column">
                    ...
                    <div class="card shadow-sm card-left3 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6 p-1">
                                    <a href="../element/img/left1.jpg" data-lightbox="id" ><img src="../element/img/left1.jpg" alt="img" class="img-fluid my-2"></a>
                                    <a href="../element/img/left2.jpg" data-lightbox="id"><img src="../element/img/left2.jpg" alt="img" class="img-fluid my-2"></a>
                                    <a href="../element/img/left3.jpg" data-lightbox="id"><img src="../element/img/left3.jpg" alt="img" class="img-fluid my-2"></a>

                                </div>


                                <div class="col-6 p-1">
                                        <a href="../element/img/left4.jpg" data-lightbox="id"><img src="../element/img/left4.jpg" alt="img" class="img-fluid my-2"></a>
                                        <a href="../element/img/left5.jpg" data-lightbox="id"><img src="../element/img/left5.jpg" alt="img" class="img-fluid my-2"></a>
                                        <a href="../element/img/left6.jpg" data-lightbox="id"><img src="../element/img/left6.jpg" alt="img" class="img-fluid my-2"></a>
